...
THEMES = {
    "dark": {
        "BG": "#050805", "PANEL": "#0d1f0d", "PANEL_BAR": "#162816",
        "CYAN": "#39FF14", "VIOLET": "#00FF66", "VIOLET2": "#22D3EE",
        "EMERALD": "#39FF14", "TEXT": "#F8FAFC", "MUTED": "#88aa88",
        "DIM": "#446644",
        "STROKE": "rgba(57,255,20,0.35)", "STROKE_HI": "rgba(57,255,20,0.65)",
        "STROKE_LO": "rgba(57,255,20,0.20)", "BARLINE": "rgba(57,255,20,0.15)",
        "RING_BG": "rgba(57,255,20,0.15)", "PILL_BG": "rgba(0,255,102,0.18)",
        "PILL_STROKE": "rgba(57,255,20,0.5)", "MONO_TX": "#e0ffe0",
    },
    "light": {
        "BG": "#F8FAFC", "PANEL": "#FFFFFF", "PANEL_BAR": "#F1F5F9",
        "CYAN": "#059669", "VIOLET": "#047857", "VIOLET2": "#0891B2",
        "EMERALD": "#10B981", "TEXT": "#0F172A", "MUTED": "#475569",
        "DIM": "#94A3B8",
        "STROKE": "rgba(5,150,105,0.30)", "STROKE_HI": "rgba(5,150,105,0.55)",
        "STROKE_LO": "rgba(5,150,105,0.20)", "BARLINE": "rgba(0,0,0,0.08)",
        "RING_BG": "rgba(100,116,139,0.20)", "PILL_BG": "rgba(5,150,105,0.12)",
        "PILL_STROKE": "rgba(5,150,105,0.4)", "MONO_TX": "#FFFFFF",
    },
}
